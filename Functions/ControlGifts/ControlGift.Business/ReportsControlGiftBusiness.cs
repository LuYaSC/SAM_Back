...
using SAM.Core.Reports;

namespace SAM.Functions.ControlGift.Business
{
    public class ReportsControlGiftBusiness : BaseReport<Databases.DbSam.Core.Data.ControlGift, ControlGiftsContext>, IReportsControlGiftBusiness
    {
        IMapper mapper;
        int userId;
